...
class Triangle{
    public:
        ...
        Triangle(Vector4 v1, Vector4 v2, Vector4 v3, VertexInterpolants interp1, VertexInterpolants interp2, VertexInterpolants interp3);
...
using VertexInterpolants = Triangle::VertexInterpolants;
